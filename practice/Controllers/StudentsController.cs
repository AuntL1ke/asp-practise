...
namespace practice.Controllers
{
    public class StudentsController : Controller
    {
        ...
        public async Task<IActionResult> EditPost(int? id)
        {
            ...
            if (await TryUpdateModelAsync<Student>(studentToUpdate, "", s => s.FirstMidName, s => s.LastName, studentToUpdate => studentToUpdate.EnrollmentDate))
            {
                try
                {
                    await _context.SaveChangesAsync();
            ...
            // ALTERNATIVE HTTPPOST EDIT CODE
